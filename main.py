...
BAD_WORDS = [
    ...
    "whore","prick","motherfucker","nigger","cock","pussy","twat","jerk","idiot","9LAWI","9lawi","zok","zb","MOK",
    "moron","dumbass","nik","nik mok","9A7BA","zaml","كلب","نيك","نيك مك","كس","mok",
    "نيك يماك","قحبة","ولد القحبة","ابن الكلب","حمار","غبي","قذر","حقير","كافر","زب","زبي","قلاوي","زك","الزك","نكمك","عطاي","حيوان","منيوك","خنزير",
    "خائن","متسكع","أرعن","حقيرة","لعينة","مشين","زانية","أوغاد","حيوان","أهبل","لعين","منيك","ترمة","مترم","بقرة","شرموطة","الشرموطة","العاهرة",
    "قليل الأدب","ابن الشرموطة","كس أمك","كس أختك","ابن القحبة","ابن الزانية",
    "ابن العاهرة","ابن الحرام","ابن الزنا"
]

# --- Normalize text (إزالة الرموز + استبدالات leetspeak) ---
def normalize_text(text: str) -> str:
    ...
    # 3. خريطة استبدالات شاملة (leetspeak + رموز + يونكود)
    replacements = {
        # --- A ---
        "@": "a", "4": "a", "à": "a", "á": "a", "â": "a", "ä": "a", "å": "a", "ª": "a", "^": "a",
    ...
    # 6. حذف الرموز الغير حروف/أرقام
    text = re.sub(r"[^a-z0-9\u0621-\u064A]+", "", text)

    # 7. حذف التكرارات الطويلة (مثال: cooool → col)
...
def contains_bad_word(message_content: str) -> bool:
    content = normalize_text(message_content)
