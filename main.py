...
# --- قنوات الموسيقى المسموح بها ---
MUSIC_CHANNELS = [123456789012345678]  # ضع ID قناة الموسيقى هنا

def is_music_command(message: str) -> bool:
    return message.startswith("m!p ") or message.startswith("m!play ")

# --- قائمة الكلمات المسيئة ---
BAD_WORDS = [
    "fuck","7mar","shit","bitch","asshole","bastard","dick","douche","cunt","fag","slut",
    "قلوة","ختك","سوتيان","خرى","خرية","106","whore","prick","motherfucker","nigger",
    "cock","pussy","twat","jerk","idiot","سوة","سوى","سخون","سليب","منوي","حواي",
    "9LAWI","9lawi","zok","zb","MOK","moron","dumbass","nik","nik mok","9A7BA",
    "الطبون","طبون","زبور","الزبور","no9ch","نقش","lkelb","الكلب","الحمار","zaml",
    "كلب","نيك","نيك مك","كس","mok","نيك يماك","قحبة","ولد القحبة","حتشون","ابن الكلب",
    "حمار","غبي","قذر","حقير","كافر","زب","زبي","قلاوي","زك","نحويك","زامل","طيز",
    "الزك","نكمك","عطاي","حيوان","منيوك","خنزير","خائن","متسكع","أرعن","شكوبي",
    "حقيرة","لعينة","مشين","زانية","أوغاد","أهبل","لعين","منيك","ترمة","مترم","بقرة",
    "شرموطة","الشرموطة","العاهرة","قليل الأدب","ابن الشرموطة","غيول","كس أمك","كس أختك",
    "ابن القحبة","ابن الزانية","ابن العاهرة","ابن الحرام","ابن الزنا"
]

# --- قائمة الكلمات المسموحة ---
ALLOWED_WORDS = ["ok","اك","اوكي","yes","تمام","نعم"]

# --- Normalization ---
MIXED_MAP = {"a":"ا","A":"ا","b":"ب","B":"ب","t":"ت","T":"ت","th":"ث","TH":"ث",
             "j":"ج","J":"ج","h":"ح","H":"ح","kh":"خ","KH":"خ","d":"د","D":"د",
             "dh":"ذ","DH":"ذ","r":"ر","R":"ر","z":"ز","Z":"ز","s":"س","S":"س",
             "sh":"ش","SH":"ش","S":"ص","D":"ض","T":"ط","Z":"ظ","e":"ع","E":"ع",
             "gh":"غ","GH":"غ","f":"ف","F":"ف","q":"ق","Q":"ق","k":"ك","K":"ك",
             "l":"ل","L":"ل","m":"م","M":"م","n":"ن","N":"ن","h":"ه","H":"ه",
             "w":"و","W":"و","y":"ي","Y":"ي","i":"ي","I":"ي","o":"و","O":"و",
             "4":"ا","3":"ع","7":"ح","5":"خ","2":"ء","9":"ق","0":"و","$":"س","@":"ا"}

REPLACEMENTS = {"@":"a","4":"a","à":"a","á":"a","â":"a","ä":"a","å":"a","ª":"a",
                "8":"b","ß":"b","(":"c","¢":"c","©":"c","ç":"c","3":"e","€":"e",
                "&":"e","ë":"e","è":"e","é":"e","ê":"e","6":"g","9":"g","#":"h",
                "!":"i","1":"i","¡":"i","|":"i","í":"i","î":"i","ï":"i","ì":"i",
                "£":"l","¬":"l","0":"o","ò":"o","ó":"o","ô":"o","ö":"o","ø":"o",
                "¤":"o","$":"s","5":"s","§":"s","š":"s","7":"t","+":"t","†":"t",
                "2":"z","¥":"y","¶":"p","*":"","^":"","~":"","`":"","?":"","!":"",
                "-":"","=":"",",":"","." :""}
...
def contains_bad_word(message: str) -> bool:
    ...
    for bad in BAD_WORDS:
        ...
        if bad_norm in text:
            return True
        for w in re.findall(r"[a-z0-9\u0621-\u064A]+", text):
...
async def on_message(message):
    ...
    if not any(role.permissions.manage_messages for role in message.author.roles):
        if contains_link(message.content):
            if message.channel.id in MUSIC_CHANNELS and is_music_command(message.content):
                # السماح مؤقتاً ثم حذف الرابط بعد 5 ثواني
